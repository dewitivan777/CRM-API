...
namespace AuthService.Repositories
{
    public class UserManager : IUserManager
    {
        ...
        public UserManager(Microsoft.AspNetCore.Identity.IPasswordHasher<string> hasher,
        ...
        public async Task RemoveClaimAsync(IdentityUser user, UserClaim claim)
        {
        ...
        public async Task AddClaimAsync(IdentityUser user, UserClaim claim)
        {
            using (var db = new SqlDbContext(_options))
            {
                try
